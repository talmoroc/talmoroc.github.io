...
_1795: (x0,x1,x2) => x0.fetch(x1,x2),
_1796: (x0,x1) => x0.get(x1),
_1797: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1797(f,arguments.length,x0,x1,x2) }),
_1798: (x0,x1) => x0.forEach(x1),
_1800: () => new AbortController(),
_1801: x0 => x0.getReader(),
_1802: x0 => x0.read(),
_1803: x0 => x0.cancel(),
_1821: (s, m) => {
          try {
